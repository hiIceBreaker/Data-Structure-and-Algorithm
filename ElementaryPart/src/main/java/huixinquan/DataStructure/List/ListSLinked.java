...
import huixinquan.DataStructure.Graph.SLNode;
...
public class ListSLinked implements List {
    ...
    @Override//返回线性表的大小，即数据元素的个数
    public int getSize() {
        return size;
    }

    @Override//如果线性表为空返回true,否则返回false
    public boolean isEmpty() {
        return size==0;
    }

    @Override//判断线性表是否包含数据元素e
    ...
    @Override//替换线性表中序号为i的数据元素为e,返回原数据元素
