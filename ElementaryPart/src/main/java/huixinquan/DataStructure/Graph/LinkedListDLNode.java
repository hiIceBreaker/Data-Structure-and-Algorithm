...
public class LinkedListDLNode implements LinkedList {
    ...
    @Override//将e作为最后一个元素插入列表，并返回e所在结点
    ...
    @Override//将e插入至p之后的位置，并返回e所在的结点
    ...
    @Override//将e插入至p之前的位置，并返回e所在的结点
    ...
    @Override//将处于给定位置的元素替换为新元素，并返回被替换的元素
