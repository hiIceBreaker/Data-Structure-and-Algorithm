...
public class Edge {
    ...
    private Node edgeSecondPosition;//在无向图中就是在两个顶点的邻接表中的位置
    ...
    public void setEdgePosition(Node edgePosition) { this.edgePosition = edgePosition; }

    public Node getFirstVexPosition() { return firstVexPosition; }
    public void setFirstVexPosition(Node firstVexPosition) { this.firstVexPosition = firstVexPosition; }

    public Node getSecondVexPosition() { return secondVexPosition; }
    public void setSecondVexPosition(Node secondVexPosition) { this.secondVexPosition = secondVexPosition; }

    public Node getEdgeFirstPosition() { return edgeFirstPosition; }
    public void setEdgeFirstPosition(Node edgeFirstPosition) { this.edgeFirstPosition = edgeFirstPosition; }

    public Node getEdgeSecondPosition() { return edgeSecondPosition; }
    public void setEdgeSecondPosition(Node edgeSecondPosition) { this.edgeSecondPosition = edgeSecondPosition; }
