package huixinquan.DataStructure.recursion;
...
public class Recursion {
    ...
    private void hanio(int n, char x, char y, char z) {
        if(n==1) move(x,n,z);
        else{
            hanio(n-1,x,z,y);
            move(x,n,z);
    ...
    private IntPair simpleMinMax(int[] a) {
    ...
    private int selectK(int[] a, int n, int k) {
        if(n<10){
